package mx.udg.cuvalles.superrecicler.adapters
...
class PaisAdapter(paises:ArrayList<Pais>, contexto:Context): RecyclerView.Adapter<PaisAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val vistaPais:View = LayoutInflater.from(contexto)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Picasso.get().load(pais.imagen)
            .placeholder(R.drawable.ic_launcher_background).into(holder.imagenFondo)
    }
